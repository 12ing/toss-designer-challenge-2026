...
export const reviewNotesByStep: Record<ReviewStep, ReviewNote> = {
  'attendance-conditions': {
    ...
    rule: '선택 참석자가 참석하지 못해도 확정을 막지 않지만, 가능한 사람이 더 많은 시간을 우선해요. 이번 흐름은 주최자가 직접 참석하는 회의를 가정해 주최자는 필수 고정이에요.',
  ...
  'confirmation-request': {
    ...
    rule: '변경 가능한 보호 시간만 일정 소유자에게 확인하며, 다른 사람의 일정을 자동으로 옮기지 않아요.',
